...
const Slider = () => {
    return (
        <div className="max-w-[1280px] px-5 mx-auto h-[600px]">
            <div className="carousel">
                <div id="slide1" className="carousel-item relative w-full bg-red-700">
                    <img src="https://i.ibb.co/Db1C0T9/S1.jpg" className="w-full" />
                    <div className='absolute flex items-center h-full w-full top-0 left-0 bg-black bg-opacity-30'>
